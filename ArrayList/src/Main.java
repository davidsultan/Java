...
public class Main {
	...
	public static void copyArrayList(){
		...
		ArrayList<String> nextArrayList = new ArrayList<String>(gl.getGroceryList());
		
		String[] array = new String[gl.getGroceryList().size()];
		array = gl.getGroceryList().toArray(array);
	}
}
